...
export const CommentItem = ({ comment, variant = "comment" }: CommentItemProps) => {
    ...
    const like = trpc.commentReactions.like.useMutation({
        ...
        onError: (error) => {
            toast.error("Couldn't like the comment");
    ...
    const dislike = trpc.commentReactions.dislike.useMutation({
        ...
        onError: (error) => {
            toast.error("Couldn't dislike the comment");
        ...
        <div>
            <div className="flex gap-4">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-muted-foreground">{comment.value}</p>
            ...
            {isReplyOpen && variant === "comment" && (
                <div className="mt-4 pl-14">
                    <CommentForm variant="reply" parentId={comment.id} onCancel={() => setIsReplyOpen(false)} videoId={comment.videoId} onSuccess={() => {
