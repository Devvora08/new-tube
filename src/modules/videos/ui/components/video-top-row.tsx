    ...
    return (
        <div className="flex flex-col gap-4 mt-4">
            ...
            <div className="flex items-center justify-between w-full">
                <div className="felx items-center gap-3 w-[70%]">
...
export const VideoTopRow = ({video}: VideoTopRowProps) => {
    ...
    return(
        <div className="flex flex-col gap-4 mt-4">
            ...
            <VideoDescription description={video.description} compactViews={compactViews} expandedDate={expandedDate} expandedViews={expandedViews} compactDate={compactDate}/>
        </div>
    )
}