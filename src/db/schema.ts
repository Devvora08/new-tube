...
export const videoRelations = relations(videos, ({one, many}) => ({
    ...
    comments: many(comments),
    playlistVideos: many(playlistsVideos)
}));
...
export const playlistsVideos = pgTable("playlist_videos", {
...
export const vidoeViewInsertSchema = createInsertSchema(videoViews);
...
export const vidoeReactionInsertSchema = createInsertSchema(videoReactions);
